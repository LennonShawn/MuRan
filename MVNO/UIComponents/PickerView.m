...
-(void)layoutToolBar{
    ...
    */
    ...
    UIBarButtonItem *confirmBarItem = [[UIBarButtonItem alloc]initWithCustomView:confirmButton];
...
//                [coverView setBackgroundColor:[UIColor colorWithWhite:0.0 alpha:.8]];
		...
		case enum_listType:{
			...
			[tableListPickerView selectRow:self.selTableIndex inComponent:0 animated:NO];
